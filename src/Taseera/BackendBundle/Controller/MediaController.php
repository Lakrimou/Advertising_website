...
class MediaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $media = $em->getRepository('TaseeraBackendBundle:Media')->findAll();
    ...
    {
        $media = new Media();
        $form = $this->createForm('Taseera\BackendBundle\Form\MediaType', $media);
    ...
    {
        $deleteForm = $this->createDeleteForm($medium);
        $editForm = $this->createForm('Taseera\BackendBundle\Form\MediaType', $medium);
